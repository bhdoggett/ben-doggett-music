      ...
      <div className={styles.container}>
        <main className={styles.main}>
          <p>
            ...
            pointing his video camera at me, scraping the audio from the
            resulting file, burning it to a CD, and that was my first “album.”
            I’m not going to share those songs with you.{" "}
            <HoverWord
            ...
            at friends’ houses, using their recording equipment to put some
            tracks down that I could share with family and friends. Nothing
            fancy, just vocals and guitar. This resulted in a few song
            collections that I{" "}
            <HoverWord
            ...
            and passed around. (I’m also not planning to share those songs
            here…)
          </p>
          <p>
            After graduating college, a friend offered to produce an album for
          ...
          <p>
            ...
            years, I wrote more songs than I had the time to put a full
            production behind, so I started a{" "}
            <Link
          ...
          <p>
            One year after <em>Glad</em>, I mustered up the gumption to
            cold-email some{" "}
            <Link
            ...
            , released in 2013. This project is made up of five songs that I
            wrote for my home{" "}
            <HoverWord
            ...
            production that is so creative and excellent that I can enjoy them
            as something no longer my own.
          </p>
          <p>
            <em>Deep to Deep</em> was not cheap to make. When I pulled the
            trigger on that project, I was{" "}
            <HoverWord
          ...
          <p>
            ...
            . It was invigorating to learn how to get behind the creative
            process of producing my own original songs. After <em>Love</em>, I
            continued the slow and steady pace, releasing a few singles over the
            next few years:{" "}
            <Link
          ...
          <p>
            ...
            songs, my song-writing method is largely the process of digesting
            some theme or passage from Scripture, and finding a way to sing it
            for myself and for those who might like to join in. Please consider
