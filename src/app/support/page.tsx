      ...
      <div className={styles.container}>
        <main className={styles.main}>
          ...
          <p>
            ...
            complaining, just saying. As someone who doesn't tour and doesn't
            sell merch, I long ago realized that making, producing and selling
            music would be a joy and not a money-maker. That said, finances{" "}
            <em>DO</em> offer some validation and encouragement. So...
          </p>
          <p>
            The most straighforward way to support me as an artist, if you feel
